...
const cityAreasMap: Record<string, { name: string; slug: string }[]> = {
  ...
  bangalore: [
    ...
    { name: 'Hebbal Kempapura',slug:'hebbal-kempapura'},
  ],
  jaipur: [
  ...
  lucknow: [
    ...
    { name: 'Colonelganj',      slug: 'colonelganj' },
  ],
  indore: [
    ...
    { name: 'Janta Nagar',      slug: 'janta-nagar' },
  ],
  bhopal: [
  ...
  kanpur: [
    ...
    { name: 'Juhi Kalan',       slug: 'juhi-kalan' },
  ],
  varanasi: [
