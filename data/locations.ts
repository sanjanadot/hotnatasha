// All location slugs for dynamic routing
...
export function formatLocationName(slug: string | undefined): string {
  if (!slug) return '';
  return slug
    .split('-')
...
export function isValidLocation(slug: string): boolean {
  return locationSlugs.includes(slug);
}
